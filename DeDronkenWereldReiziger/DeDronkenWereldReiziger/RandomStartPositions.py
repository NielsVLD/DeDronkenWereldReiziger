...
def draw():
    ...
    if len(spelers) == 2:
        ...
        fill(37, 107, 133)
        text("Startposities", width/2, 110)
        fill(27, 107, 133)
        ...
        rect((width/2)-75,height-125,150,50)
        textSize(25)
        text("Pak de thuisbasis en pionnen uit de doos en plaats deze op een stad in het aangegeven continent", width/2, (height/2)+25)
    textSize(15)
